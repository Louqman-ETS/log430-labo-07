...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("🚀 Démarrage du service Customers API")
    ...
    # Shutdown
    logger.info("🛑 Arrêt du service Customers API")

# Créer l'application FastAPI
app = FastAPI(
    title="🧑‍💼 Customers API",
    description="Service de gestion des comptes clients et authentification",
    version="1.0.0",
    lifespan=lifespan
)
...
async def root():
    ...
    return {
        "service": "customers-api",
        "version": "1.0.0",
        "description": "Service de gestion des comptes clients",
        "status": "running"
    }
