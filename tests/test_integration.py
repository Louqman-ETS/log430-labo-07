...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # 1. Catégories
        self.categorie_alim = Categorie(nom="Alimentaire", description="Produits alimentaires")
        self.categorie_boisson = Categorie(nom="Boissons", description="Boissons diverses")
    ...
    def test_dao_integration(self):
        ...
        produits_alim = ProduitDAO.search_by_category(self.session, self.categorie_alim.id)
